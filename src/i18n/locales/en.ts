...
export const en = {
  ...
  'settings.guideStart': 'Run the controls tour again',

  // First-run controls tour
  'onboarding.title': 'Controls tour',
  'onboarding.eyebrow': 'Welcome to TC Space',
  'onboarding.welcomeTitle': 'Learn the basics in about a minute',
  'onboarding.welcomeBody': 'Try the essential controls yourself. You will be ready to move, chat, and open the menu when the tour is done.',
  'onboarding.start': 'Start the controls tour',
  'onboarding.skip': 'Skip for now',
  'onboarding.moveTitle': 'Move your avatar',
  'onboarding.moveBody': 'Press any WASD or arrow key. On touch screens, drag the joystick at the lower left.',
  'onboarding.great': 'Great!',
  'onboarding.previewCamera': 'Camera',
  'onboarding.cameraTitle': 'Look around',
  'onboarding.cameraBody': 'Rotate the camera to look around your avatar.',
  'onboarding.cameraMouse': 'Click the world, then move the mouse',
  'onboarding.cameraTouch': 'Drag an open area of the world',
  'onboarding.zoomTitle': 'Move the camera closer or farther away',
  'onboarding.zoomBody': 'Scroll the mouse wheel over the world to zoom in or out.',
  'onboarding.viewTitle': 'Switch viewpoints',
  'onboarding.viewBody': 'Press G to switch between first-person and third-person views.',
  'onboarding.viewTouch': 'Tap the compass button at the bottom',
  'onboarding.chatTitle': 'Open chat',
  'onboarding.chatOpenBody': 'Press Enter to open the chat input.',
  'onboarding.chatTouch': 'Or tap the chat button at the bottom.',
  'onboarding.chatReadyTitle': 'You are ready to chat',
  'onboarding.chatReadyBody': 'Type a message and press Enter to send it. For now, press Esc to return to the world.',
  'onboarding.send': 'send',
  'onboarding.close': 'close',
  'onboarding.menuTitle': 'Open the menu',
  'onboarding.menuOpenBody': 'Press Esc to open the menu. Avatar, world, room, and settings are all here.',
  'onboarding.menuTouch': 'Or tap the menu button at the top right.',
  'onboarding.menuReadyTitle': 'This is the main menu',
  'onboarding.menuReadyBody': 'Press Esc again, tap ×, or choose an item. Close it once to finish the tour.',
  'onboarding.completeEyebrow': 'Controls tour complete',
  'onboarding.completeTitle': 'You are ready to explore',
  'onboarding.completeBody': 'These three controls are enough to get around. You can run this tour again any time from Settings.',
  'onboarding.summaryMove': 'to move',
  'onboarding.summaryCamera': 'Mouse movement and wheel to control the camera',
  'onboarding.summaryView': 'to switch viewpoints',
  'onboarding.summaryChat': 'to chat',
  'onboarding.summaryMenu': 'to open or close the menu',
