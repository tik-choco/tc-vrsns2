...
export const hi: Dict = {
  ...
  'join.errorRenderer': 'यह डिवाइस 3D नहीं दिखा सकता — WebGL उपलब्ध नहीं है या ब्लॉक है।',
  'join.errorTimeout': 'फिर से कनेक्ट होने में बहुत समय लग गया। कृपया दोबारा शामिल हों।',
