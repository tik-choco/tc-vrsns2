...
export const ja: Dict = {
  ...
  'npc.modeAi': 'AI応答',
  'npc.modeLines': '固定セリフ',
  'npc.modeAiHelp': 'AI設定とキャラクターのtc-townでの人格を使って、キャラクターになりきって応答します。',
  'npc.modeLinesHelp': '下に書いたセリフのみを話します。AI設定は不要です。',
  'npc.lines': 'セリフ',
  'npc.linesHint': '1行に1つのセリフを入力します。最大{max}行、各{chars}文字まで。',
  'npc.linesPlaceholder': 'こんにちは！',
  'npc.linesCount': '{n}件のセリフ',
  'npc.linesNone': 'セリフがまだありません',
  'npc.linesEmptyWarn': 'セリフのない固定セリフNPCは、何も話しません。',
  'npc.order': '再生順',
  'npc.orderSequence': '順番に',
  'npc.orderRandom': 'ランダム',
  ...
  'world.importReplaces': '読み込むと、あなたが配置した{count}個のオブジェクトは置き換えられます。他の人が配置したものはそのまま残ります。',
  ...
  // カタログ（アバター・ワールド・オブジェクトで共用する持ち物一覧）
  'catalog.search': '検索',
  'catalog.searchLabel': 'アイテムを検索',
  'catalog.clearSearch': '検索をクリア',
  'catalog.sort': '並び替え',
  'catalog.sort.recent': '新しい順',
  'catalog.sort.oldest': '古い順',
  'catalog.sort.nameAsc': '名前（昇順）',
  'catalog.sort.nameDesc': '名前（降順）',
  'catalog.sort.sizeDesc': 'サイズが大きい順',
  'catalog.sort.sizeAsc': 'サイズが小さい順',
  'catalog.view.grid': 'タイル表示',
  'catalog.view.list': 'リスト表示',
  'catalog.empty': 'まだ何も保存されていません。',
  'catalog.noMatches': '「{query}」に一致するものはありません。',
  'catalog.showing': '{total}件中{shown}件',
  'catalog.total': '{count}件',
  'catalog.kind.all': 'すべて',
  'catalog.kind.model': 'モデル',
  'catalog.kind.image': '画像',
  'catalog.kind.video': '動画',
  'catalog.kind.audio': '音声',
  'catalog.detail.kind': '種類',
  'catalog.detail.size': 'サイズ',
  'catalog.detail.added': '追加日',
  'catalog.detail.id': 'コンテンツID',
  'catalog.detail.unknown': '不明',
  'catalog.imported': '取り込み',
  ...
  // 複数ファイルの同時ドロップ
  'dropImport.titleMulti': 'これらをワールドに追加しますか？',
  'dropImport.countLabel': '{n} 件のファイル',
  'dropImport.notSupported': '非対応のため除外',
  'dropImport.skippedCount': '非対応のファイルを {n} 件スキップしました',
  'dropImport.tooManyFiles': '最初の {max} 件のみが対象です。残りは今回のドロップから除外されました。',
  'dropImport.progress': '処理中… {total} 件中 {done} 件',
  'dropImport.addAll': 'すべてワールドに追加',
  'dropImport.saveAllOnly': 'すべてインベントリにのみ保存',
  ...
  'settings.guideStart': '操作チュートリアルをもう一度見る',

  // 初回操作チュートリアル
  'onboarding.title': '操作チュートリアル',
  'onboarding.eyebrow': 'TC Spaceへようこそ',
  'onboarding.welcomeTitle': '約1分で基本操作を覚えましょう',
  'onboarding.welcomeBody': '大切な操作を実際に試します。終わるころには、移動・チャット・メニュー操作ができるようになります。',
  'onboarding.start': '操作を練習する',
  'onboarding.skip': '今はスキップ',
  'onboarding.moveTitle': 'アバターを動かしてみましょう',
  'onboarding.moveBody': 'WASDキーか矢印キーをどれか押してください。タッチ端末では左下のスティックを動かします。',
  'onboarding.great': 'できました！',
  'onboarding.previewCamera': 'カメラ',
  'onboarding.cameraTitle': '周りを見渡してみましょう',
  'onboarding.cameraBody': 'カメラを回して、アバターの周りを見渡します。',
  'onboarding.cameraMouse': 'ワールドをクリックして、マウスを動かす',
  'onboarding.cameraTouch': 'ワールドの空いている場所をドラッグ',
  'onboarding.zoomTitle': 'カメラを近づけたり離したりしましょう',
  'onboarding.zoomBody': 'ワールド上でマウスホイールを回すと、拡大・縮小できます。',
  'onboarding.viewTitle': '視点を切り替えてみましょう',
  'onboarding.viewBody': 'Gキーを押すと、一人称視点と三人称視点が切り替わります。',
  'onboarding.viewTouch': '画面下の方位磁針ボタンをタップ',
  'onboarding.chatTitle': 'チャットを開きましょう',
  'onboarding.chatOpenBody': 'Enterキーを押すと、チャット入力が開きます。',
  'onboarding.chatTouch': 'または画面下のチャットボタンをタップ',
  'onboarding.chatReadyTitle': 'チャットの準備ができました',
  'onboarding.chatReadyBody': '文字を入力してEnterで送信できます。今回はEscを押してワールドに戻りましょう。',
  'onboarding.send': '送信',
  'onboarding.close': '閉じる',
  'onboarding.menuTitle': 'メニューを開きましょう',
  'onboarding.menuOpenBody': 'Escキーでメニューが開きます。アバター、ワールド、ルーム、設定はここにあります。',
  'onboarding.menuTouch': 'または右上のメニューボタンをタップ',
  'onboarding.menuReadyTitle': 'これがメインメニューです',
  'onboarding.menuReadyBody': 'もう一度Escを押すか、×を押すか、項目を選べます。今回は閉じて完了しましょう。',
  'onboarding.completeEyebrow': '操作チュートリアル完了',
  'onboarding.completeTitle': 'これで自由に操作できます',
  'onboarding.completeBody': 'まずはこの3つを覚えておけば大丈夫です。設定からいつでもチュートリアルをやり直せます。',
  'onboarding.summaryMove': 'で移動',
  'onboarding.summaryCamera': 'マウス移動とホイールでカメラ操作',
  'onboarding.summaryView': 'で視点切り替え',
  'onboarding.summaryChat': 'でチャット',
  'onboarding.summaryMenu': 'でメニューを開く・閉じる',
  'onboarding.finish': 'ワールドを楽しむ',
